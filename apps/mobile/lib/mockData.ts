...
export const sampleRecordings: Recording[] = [
  {
    ...
    speakerTranscript: "A: Excuse me, could you tell me how to get to the station?\nB: It's just two stops ahead.",
    errorMessage: null,
  ...
  },
  {
    ...
    speakerTranscript: "A: Can I get an iced latte for here?\nB: Do you have oat milk?",
    errorMessage: null,
